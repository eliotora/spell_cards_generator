...
class FeatExport(QWidget):
    def __init__(self):
        ...
        self.selected_feat_count_label = QLabel("Dons sélectionnés: 0")
        ...
        export_buttons_layout.addWidget(self.selected_feat_count_label)
        export_buttons_layout.addWidget(self.export_pdf_btn)
        export_buttons_layout.addWidget(self.export_html_btn)
        layout.addLayout(export_buttons_layout)

    def change_selected_feat_count_label(self, nbr:int, checked:bool):
        self.selected_feat_count_label.setText(f"Dons sélectionnés: {nbr}")
