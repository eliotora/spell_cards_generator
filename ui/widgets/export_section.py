...
from export.html_export import RULES, GRIMOIRE, CARDS
...
class ExportSection(QWidget):
    def __init__(self):
        ...
        self.format_group.addButton(self.radio_grimoire, id=GRIMOIRE)
    ...
    def change_selected_spell_count_label(self, nbr:int, checked:bool):
        self.selected_spell_count_label.setText(f"Sorts sélectionnés: {nbr}")
