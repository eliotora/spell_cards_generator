...
class ProfileModel(BaseModel, ExplorableMixin, JsonMixin, PopupMixin, ExportableMixin):
    ...
    stats: dict[str, int] = field(
        metadata={
            ExplorableMixin.METADATA_NAMESPACE: ExplorerMetadata(
                label="Caractéristiques", visibility=VisibilityOption.ALWAYS_HIDDEN
            ),
            JsonMetadata.METADATA_NAMESPACE: JsonMetadata(),
        }
    )
    ...
    pb: str = field(
        metadata={
            ExplorableMixin.METADATA_NAMESPACE: ExplorerMetadata(
                label="Bonus de maîtrise", visibility=VisibilityOption.ALWAYS_HIDDEN
            ),
            JsonMetadata.METADATA_NAMESPACE: JsonMetadata(),
        },
        default="+0",
    ...
    source: str = field(
        metadata={
            ExplorableMixin.METADATA_NAMESPACE: ExplorerMetadata(
                label="Source", visibility=VisibilityOption.HIDDABLE, cols_to_hide=(12,)
            ),
    ...
    proficiencies: dict[str, str] = (
        field(  # "proficiencies": {"Arcane": "P", "JS_FOR": "E", "Initiative": "P"} -> P pour proficiency (+BM) ; E pour expertise (+2xBM)
            metadata={
                ExplorableMixin.METADATA_NAMESPACE: ExplorerMetadata(
                    label="Compétences", visibility=VisibilityOption.ALWAYS_HIDDEN
                ),
                JsonMetadata.METADATA_NAMESPACE: JsonMetadata(),
            },
    ...
    details: dict[str, str] = field(
        metadata={
            ExplorableMixin.METADATA_NAMESPACE: ExplorerMetadata(
                label="Détails", visibility=VisibilityOption.ALWAYS_HIDDEN
            ),
            JsonMetadata.METADATA_NAMESPACE: JsonMetadata(),
        },
        default=None,
    ...
    traits: Optional[dict[str, str]] = field(
        metadata={
            ExplorableMixin.METADATA_NAMESPACE: ExplorerMetadata(
                label="Traits", visibility=VisibilityOption.ALWAYS_HIDDEN
            ),
            JsonMetadata.METADATA_NAMESPACE: JsonMetadata(),
        },
        default=None,
    ...
    actions: Optional[dict[str, str]] = field(
        metadata={
            ExplorableMixin.METADATA_NAMESPACE: ExplorerMetadata(
                label="Actions", visibility=VisibilityOption.ALWAYS_HIDDEN
            ),
            JsonMetadata.METADATA_NAMESPACE: JsonMetadata(),
        },
        default=None,
    ...
    bonus_actions: Optional[dict[str, str]] = field(
        metadata={
            ExplorableMixin.METADATA_NAMESPACE: ExplorerMetadata(
                label="Actions bonus", visibility=VisibilityOption.ALWAYS_HIDDEN
            ),
            JsonMetadata.METADATA_NAMESPACE: JsonMetadata(),
        },
        default=None,
    ...
    reactions: Optional[dict[str, str]] = field(
        metadata={
            ExplorableMixin.METADATA_NAMESPACE: ExplorerMetadata(
                label="Réactions", visibility=VisibilityOption.ALWAYS_HIDDEN
            ),
            JsonMetadata.METADATA_NAMESPACE: JsonMetadata(),
        },
        default=None,
    ...
    legendary_actions: Optional[dict[str, str]] = field(
        metadata={
            ExplorableMixin.METADATA_NAMESPACE: ExplorerMetadata(
                label="Actions légendaires", visibility=VisibilityOption.ALWAYS_HIDDEN
            ),
            JsonMetadata.METADATA_NAMESPACE: JsonMetadata(),
        },
        default=None,
    ...
    legendary_text: Optional[str] = field(
        metadata={
            ExplorableMixin.METADATA_NAMESPACE: ExplorerMetadata(
                label="Texte légendaire", visibility=VisibilityOption.ALWAYS_HIDDEN
            )
        },
        default=None,
    )
    ...
    def get_html_dict(self):
        ...
        res = {
            ...
            "bonus_actions": [
                ...
                for key, value in self.bonus_actions.items()
            ],
            "reactions": [
            ...
            "legendary_actions": [
                {"name": key, "value": value}
                for key, value in self.legendary_actions.items()
            ],
